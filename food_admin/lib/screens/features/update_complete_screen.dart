...
import 'package:food_admin/models/category_model.dart';
...
class _UpdateCompleteScreenState extends State<UpdateCompleteScreen> {
  ...
  void initState() {
    ...
    productTitleController.text = widget.products!.productName!;
    productDetailController.text = widget.products!.detail!;
    productPriceController.text = widget.products!.price!.toString();
